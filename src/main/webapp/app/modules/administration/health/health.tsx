      ...
      <Row>
        <Col md="12">
          <Table bordered aria-describedby="health-page-heading">
            <thead>
              <tr>
                <th><Translate contentKey="health.table.service">Service Name</Translate></th>
                <th><Translate contentKey="health.table.status">Status</Translate></th>
                <th><Translate contentKey="health.details.details">Details</Translate></th>
              </tr>
            </thead>
            <tbody>
